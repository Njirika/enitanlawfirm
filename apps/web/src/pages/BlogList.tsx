...
const { data: blogData, isLoading, error } = useListBlogPosts(queryParams, {
      ...
      <section className="py-12 container mx-auto px-4 md:px-8 max-w-7xl">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-destructive/5 rounded-xl border border-destructive/20">
            <h3 className="text-2xl font-serif font-bold text-destructive mb-2">Failed to load articles</h3>
            <p className="text-muted-foreground">There was a problem connecting to the server. Please try again later.</p>
            <Button 
              variant="outline" 
              className="mt-6 border-destructive/20 text-destructive hover:bg-destructive/10"
